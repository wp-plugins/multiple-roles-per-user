...
Works when creating or editing an user.
...
== Installation ==
1. Upload the 'multiple-roles-per-user' folder to the '/wp-content/plugins/' directory.
2. Activate the plugin through the Plugins menu in WordPress.
3. Start adding multiple rules to users.

== Frequently Asked Questions ==

= Will this plugin work when creating or editing an user? =
Yes.
